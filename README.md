...
Usercorn depends on Go 1.18 or newer, as well as the latest 1.x versions of Capstone, Unicorn, and Keystone.

`make deps` (requires `cmake`) will attempt to install Capstone, Unicorn, and Keystone into the source tree under `deps/`.
